<template>
  <div class="min-h-screen bg-[#181818] text-white px-0 md:px-8 py-0 md:py-12">
    ...
    <nav class="flex justify-center w-full gap-18 text-sm font-bold uppercase mt-4 mb-8">
      <button @click="scrollToSection('services')" class="focus:outline-none">Services</button>
      <button @click="scrollToSection('tarifs')" class="focus:outline-none">Tarifs</button>
    </nav>
      ...
      <div class="flex flex-col md:flex-row gap-16 w-full max-w-6xl items-center justify-center">
        <div class="md:w-1/2 flex flex-col justify-center items-center md:items-end">
          <div class="max-w-md w-full flex flex-col justify-center">
            <h1 class="text-4xl md:text-5xl font-extrabold mb-4 text-center md:text-right">SERVICES</h1>
            <p class="mb-2 text-xs md:text-sm text-center md:text-right">
    ...
    >
      <div class="flex flex-col md:flex-row gap-16 w-full max-w-6xl items-center justify-center">
        ...
        <div class="md:w-1/2 flex flex-col justify-center items-center md:items-start order-1 md:order-2">
          <div class="max-w-md w-full flex flex-col justify-center">
            <h2 class="text-4xl md:text-5xl font-extrabold mb-4 text-center md:text-left">TARIFS</h2>
            <p class="font-bold mb-2 text-center md:text-left">Sous devis</p>
            <p class="text-xs md:text-sm text-center md:text-left">Numéro de tel : 06 32 54 68 24</p>
            <p class="text-xs md:text-sm text-center md:text-left">Mail : mail@mail.com</p>
            <p class="text-xs md:text-sm text-center md:text-left">Localisation : Rhône-Alpes</p>
          </div>
        </div>
      </div>
    </section>
